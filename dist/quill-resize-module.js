    ...
    container.addEventListener("click", function (e) {
      ...
      if (e.target && ["img", "video"].includes(target.tagName.toLowerCase())) {
        ...
        resizePlugin = new ResizePlugin(
          ...
          __assign(__assign({}, options), { onChange: triggerTextChange })
        );
      }
    });
    ...
    document.addEventListener(
      ...
      function (e) {
        ...
        if (
          ...
          !((_b =
            (_a =
              resizePlugin === null || resizePlugin === void 0
                ? void 0
                : resizePlugin.resizer) === null || _a === void 0
              ? void 0
          ...
          (_c =
            resizePlugin === null || resizePlugin === void 0
              ? void 0
              : resizePlugin.destory) === null || _c === void 0
            ? void 0
            : _c.call(resizePlugin);
          resizePlugin = null;
          resizeTarge = null;
        }
      },
