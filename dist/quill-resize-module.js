    ...
    var ResizePlugin = /** @class */ (function () {
        ...
        ResizePlugin.prototype.positionResizerToTarget = function (el) {
            if (this.resizer !== null) {
                ...
                document.getElementsByName("ql-size").item(0).innerHTML = (el.getAttribute("width") ? el.getAttribute("width") : el.clientWidth) + " x " + (el.getAttribute("height") ? el.getAttribute("height") : el.clientHeight);
            }
        };
